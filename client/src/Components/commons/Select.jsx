        ...
        >
          {({ open }) => (
            <>
              ...
              >
                <Listbox.Options className="absolute max-h-64 w-full mt-2 z-50 overflow-y-auto rounded border-2 border-gray-300 bg-white">
                  {items.map((item) => (
                    <Listbox.Option
                      className="p-2 rounded cursor-pointer select-none hover:bg-blue-900 hover:text-white"
                      key={item}
                      value={item}
                    >
                      {item}
