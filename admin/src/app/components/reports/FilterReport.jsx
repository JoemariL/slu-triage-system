    ...
    sampleReport.forEach((entries) => {
      entries.info
        ...
        .forEach((school) => {
          ...
          //
          //Course checker
          for (let course in school["department_list"]) {
      ...
      Object.keys(gate["Gate 2"]).forEach((key) => {
        console.log(key);
        console.log(gate["Gate 2"][key]);
      });
    });
    return (
      <>
          ...
          <tbody>
            ...
            {gate["Gate 1"]?.total_entry > 0 ? (
              <tr>
                ...
                <td>
                  {gate["Gate 1"]?.students > 0 ? (
                    gate["Gate 1"]?.students
                  ) : (
                    <>0</>
                  )}
                </td>
                ...
                <td>
                  {gate["Gate 1"]?.visitors > 0 ? (
                    gate["Gate 1"]?.visitors
                  ) : (
                    <>0</>
                  )}
                </td>
            ...
            {gate["Gate 2"]?.total_entry > 0 ? (
              <tr>
                ...
                <td>
                  {gate["Gate 2"]?.students > 0 ? (
                    gate["Gate 2"]?.students
                  ) : (
                    <>0</>
                  )}
                </td>
                ...
                <td>
                  {gate["Gate 2"]?.visitors > 0 ? (
                    gate["Gate 2"]?.visitors
                  ) : (
                    <>0</>
                  )}
                </td>
            ...
            {gate["Gate 3"]?.total_entry > 0 ? (
              <>
                ...
                <tr>
                  ...
                  <td>
                    {gate["Gate 3"]?.students > 0 ? (
                      gate["Gate 3"]?.students
                    ) : (
                      <>0</>
                    )}
                  </td>
                  ...
                  <td>
                    {gate["Gate 3"]?.visitors > 0 ? (
                      gate["Gate 3"]?.visitors
                    ) : (
                      <>0</>
                    )}
                  </td>
            ...
            {gate["Gate 4"]?.total_entry > 0 ? (
              <>
                ...
                <tr>
                  ...
                  <td>
                    {gate["Gate 4"]?.students > 0 ? (
                      gate["Gate 4"]?.students
                    ) : (
                      <>0</>
                    )}
                  </td>
                  ...
                  <td>
                    {gate["Gate 4"]?.visitors > 0 ? (
                      gate["Gate 4"]?.visitors
                    ) : (
                      <>0</>
                    )}
                  </td>
            ...
            <tr>
              ...
              <td>
                {CampusTotal?.total_entry > 0 ? (
                  CampusTotal?.total_entry
                ) : (
                  <>0</>
                )}
              </td>
              <td>
                {CampusTotal?.allowed > 0 ? CampusTotal?.allowed : <>0</>}
              </td>
              <td>
                {CampusTotal?.not_allowed > 0 ? (
                  CampusTotal?.not_allowed
                ) : (
                  <>0</>
                )}
              </td>
